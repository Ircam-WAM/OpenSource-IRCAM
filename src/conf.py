...
project = u'Guide Open Source @IRCAM'
authors = u'Guillaume Pellerin, ...'
...
htmlhelp_basename = 'OpenSource@IRCAM'
...
latex_documents = [
  ('index', 'Guide_Open_Source_@IRCAM.tex', u'Guide Open Source @IRCAM',
   authors, 'manual'),
]
...
def setup(app):
    app.add_config_value('recommonmark_config', {
        ...
        'auto_toc_tree_section': 'Contenus',
